<?php
/**
 * Tambah Alat Baru - Form dengan sidebar layout
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jumlah_baik = (int)($_POST['jumlah_baik'] ?? 1);
    ...
    if (empty($errors)) {
        try {
            ...
            if (!empty($pengguna_terpilih)) {
                ...
                $stmt_pengguna = $pdo->prepare("INSERT INTO alat_pengguna (id_alat, id_user, tanggal_diberikan, status, keterangan, user_record) VALUES (?, ?, ?, 'aktif', ?, ?)");
                foreach ($pengguna_terpilih as $id_user) {
...
<form method="POST" autocomplete="off" id="alatForm">
                    <input type="hidden" name="pengguna" id="penggunaSelected" value="">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="nama_alat" name="nama_alat" 
                                   ...
                                   placeholder="Contoh: Ketipung, Rebana, Terbang" required
                                   onblur="validateAlatName()" oninput="clearAlatValidation()">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control text-center fw-bold" id="total_alat" 
                                       name="total_alat" value="<?= $_POST['total_alat'] ?? 1 ?>" min="1" required
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control text-center" id="jumlah_baik" 
                                       name="jumlah_baik" value="<?= $_POST['jumlah_baik'] ?? 1 ?>" min="0" required
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control text-center" id="jumlah_rusak" 
                                       name="jumlah_rusak" value="<?= $_POST['jumlah_rusak'] ?? 0 ?>" min="0"
                                       onchange="validateQuantity()" oninput="validateQuantity()">
                                <button type="button" class="btn btn-outline-danger" onclick="adjustRusak(1)">
                                    <i class="fas fa-plus"></i>
                                </button>
                    ...
                    <h6 class="text-primary mb-3"><i class="fas fa-users me-1"></i> Assign Pengguna</h6>
                    
                    <div class="mb-3">
                        <button type="button" class="btn btn-outline-primary" onclick="openPenggunaModal()">
                            <i class="fas fa-users-cog me-1"></i> 
                            Pilih Anggota <span class="badge bg-primary ms-1" id="selectedCount">0</span> terpilih
                        </button>
                        <div class="form-text">Klik untuk memilih anggota yang akan menggunakan alat ini</div>
                    </div>
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="button" class="btn btn-primary btn-lg" onclick="if(validateAlatName()) { showConfirmModal(); }">
...
function validateAlatName() {
    ...
    alatValidationTimeout = setTimeout(function() {
        fetch(`api_check_alat.php?nama_alat=${encodeURIComponent(namaAlat)}&mode=add`)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('searchPengguna')?.addEventListener('keydown', function(e) {
        if (e.key === 'Escape') {
            clearSearch();
        }
